...
#[test]
fn alter_rc_str() {
    // TODO: So ugly, should see if I can optimize the ergonomics for reference counted keys/values.
    let hello = Rc::new(String::from("hello"));
    let world = Rc::new(String::from("world"));
    let new_world = Rc::new(String::from("new_world"));
    let mut hamt = HamtRc::<Rc<String>, Rc<String>>::new().insert(hello.clone(), world.clone());
